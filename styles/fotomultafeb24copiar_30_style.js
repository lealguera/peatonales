...
var style_fotomultafeb24copiar_30 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 9.2 + size, points: 6,
        ...
        image: new ol.style.RegularShape({radius: 3.76364 + size, points: 6,
