...
var format_Combinado_29 = new ol.format.GeoJSON();
var features_Combinado_29 = format_Combinado_29.readFeatures(json_Combinado_29, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Combinado_29 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Combinado_29.addFeatures(features_Combinado_29);
var lyr_Combinado_29 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Combinado_29, 
                style: style_Combinado_29,
                interactive: true,
    title: 'Combinado<br />\
    <img src="styles/legend/Combinado_29_0.png" /> AHUACHAPAN (2 INTER)<br />\
    <img src="styles/legend/Combinado_29_1.png" /> APOPA (1 INTER)<br />\
    <img src="styles/legend/Combinado_29_2.png" /> MERLIOT (7 INTER)<br />\
    <img src="styles/legend/Combinado_29_3.png" /> METAPAN (5 INTER)<br />\
    <img src="styles/legend/Combinado_29_4.png" /> QUEZALTEPEQUE (1 INTER)<br />\
    <img src="styles/legend/Combinado_29_5.png" /> SANTA TECLA (10 INTER)<br />\
    <img src="styles/legend/Combinado_29_6.png" /> SONSONATE (5 INTER)<br />\
    <img src="styles/legend/Combinado_29_7.png" /> SOYAPANGO (7 INTER)<br />\
    <img src="styles/legend/Combinado_29_8.png" /> ZONA 1 (14 iNTER)<br />\
    <img src="styles/legend/Combinado_29_9.png" /> ZONA 10 (22 INTER)<br />\
    <img src="styles/legend/Combinado_29_10.png" /> ZONA 11 (28 INTER)<br />\
    <img src="styles/legend/Combinado_29_11.png" /> ZONA 12 (22 INTER)<br />\
    <img src="styles/legend/Combinado_29_12.png" /> ZONA 13 (9 INTER)<br />\
    <img src="styles/legend/Combinado_29_13.png" /> ZONA 14 (2 iNTER)<br />\
    <img src="styles/legend/Combinado_29_14.png" /> ZONA 15 (7 iNTER)<br />\
    <img src="styles/legend/Combinado_29_15.png" /> ZONA 2 (11 INTER)<br />\
    <img src="styles/legend/Combinado_29_16.png" /> ZONA 20 (15 INTER)<br />\
    <img src="styles/legend/Combinado_29_17.png" /> ZONA 21 (24 INTER)<br />\
    <img src="styles/legend/Combinado_29_18.png" /> ZONA 22 (6 INTER)<br />\
    <img src="styles/legend/Combinado_29_19.png" /> ZONA 23 (7 INTER)<br />\
    <img src="styles/legend/Combinado_29_20.png" /> ZONA 3 (4 INTER)<br />\
    <img src="styles/legend/Combinado_29_21.png" /> ZONA 4 (13 INTER)<br />\
    <img src="styles/legend/Combinado_29_22.png" /> ZONA 5 (9 INTER)<br />\
    <img src="styles/legend/Combinado_29_23.png" /> ZONA 6 (12 INTER)<br />\
    <img src="styles/legend/Combinado_29_24.png" /> ZONA 7 (10 INTER)<br />\
    <img src="styles/legend/Combinado_29_25.png" /> ZONA 8 (12 INTER)<br />\
    <img src="styles/legend/Combinado_29_26.png" /> ZONA 9 (9 INTER)<br />\
    <img src="styles/legend/Combinado_29_27.png" /> ZONA 99 (24 INTER)<br />\
    <img src="styles/legend/Combinado_29_28.png" /> <br />'
        });
var format_Crucepeatonal24FEB_30 = new ol.format.GeoJSON();
var features_Crucepeatonal24FEB_30 = format_Crucepeatonal24FEB_30.readFeatures(json_Crucepeatonal24FEB_30, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Crucepeatonal24FEB_30 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Crucepeatonal24FEB_30.addFeatures(features_Crucepeatonal24FEB_30);
var lyr_Crucepeatonal24FEB_30 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Crucepeatonal24FEB_30, 
                style: style_Crucepeatonal24FEB_30,
                interactive: true,
                title: '<img src="styles/legend/Crucepeatonal24FEB_30.png" /> Cruce peatonal 24 FEB'
            });
var format_fotomultafeb24copiar_31 = new ol.format.GeoJSON();
var features_fotomultafeb24copiar_31 = format_fotomultafeb24copiar_31.readFeatures(json_fotomultafeb24copiar_31, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_fotomultafeb24copiar_31 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_fotomultafeb24copiar_31.addFeatures(features_fotomultafeb24copiar_31);
var lyr_fotomultafeb24copiar_31 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_fotomultafeb24copiar_31, 
                style: style_fotomultafeb24copiar_31,
                interactive: true,
                title: '<img src="styles/legend/fotomultafeb24copiar_31.png" /> fotomulta feb 24 copiar'
            });
...
lyr_Combinado_29.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', 'layer': 'layer', 'path': 'path', });
lyr_Crucepeatonal24FEB_30.set('fieldAliases', {'extrude': 'extrude', 'SISTEMA': 'SISTEMA', 'LUCES': 'LUCES', 'CÓDIGO': 'CÓDIGO', 'TENTATIVO': 'TENTATIVO', 'OBSERVASI�': 'OBSERVASI�', });
lyr_fotomultafeb24copiar_31.set('fieldAliases', {'CONTROL': 'CONTROL', 'SISTEMA': 'SISTEMA', });
...
lyr_Combinado_29.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
lyr_Crucepeatonal24FEB_30.set('fieldImages', {'extrude': 'Range', 'SISTEMA': 'TextEdit', 'LUCES': 'TextEdit', 'CÓDIGO': 'TextEdit', 'TENTATIVO': 'TextEdit', 'OBSERVASI�': 'TextEdit', });
lyr_fotomultafeb24copiar_31.set('fieldImages', {'CONTROL': 'TextEdit', 'SISTEMA': 'TextEdit', });
...
lyr_Combinado_29.set('fieldLabels', {'Name': 'inline label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', 'layer': 'header label', 'path': 'no label', });
lyr_Crucepeatonal24FEB_30.set('fieldLabels', {'extrude': 'no label', 'SISTEMA': 'no label', 'LUCES': 'no label', 'CÓDIGO': 'header label', 'TENTATIVO': 'no label', 'OBSERVASI�': 'no label', });
lyr_fotomultafeb24copiar_31.set('fieldLabels', {'CONTROL': 'no label', 'SISTEMA': 'no label', });
lyr_fotomultafeb24copiar_31.on('precompose', function(evt) {
