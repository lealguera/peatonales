...
var format_CRUCESPEATONALFEB20rehecho_30 = new ol.format.GeoJSON();
var features_CRUCESPEATONALFEB20rehecho_30 = format_CRUCESPEATONALFEB20rehecho_30.readFeatures(json_CRUCESPEATONALFEB20rehecho_30, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CRUCESPEATONALFEB20rehecho_30 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CRUCESPEATONALFEB20rehecho_30.addFeatures(features_CRUCESPEATONALFEB20rehecho_30);
var lyr_CRUCESPEATONALFEB20rehecho_30 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_CRUCESPEATONALFEB20rehecho_30, 
                style: style_CRUCESPEATONALFEB20rehecho_30,
                interactive: true,
                title: '<img src="styles/legend/CRUCESPEATONALFEB20rehecho_30.png" /> CRUCES PEATONAL FEB 20 — rehecho'
            });
...
lyr_CRUCESPEATONALFEB20rehecho_30.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', 'SISTEMA': 'TextEdit', 'LUCES': 'TextEdit', 'CÓDIGO': 'TextEdit', 'TENTATIVO': 'TextEdit', 'OBSERVASIÓN': 'TextEdit', });
...
lyr_CRUCESPEATONALFEB20rehecho_30.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'inline label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', 'SISTEMA': 'inline label', 'LUCES': 'inline label', 'CÓDIGO': 'header label', 'TENTATIVO': 'inline label', 'OBSERVASIÓN': 'inline label', });
lyr_CRUCESPEATONALFEB20rehecho_30.on('precompose', function(evt) {
